...
<p align="center"><img src="https://github.com/Paybook/sync-php/blob/master/examples/download_invoices_wizard/wizard.png"></p>
...
6. Una vez que hayas terminado la ejecución del *Wizard* podrás observar las facturas descargadas (archivos XML) dentro del directorio:
	...
	**Importante:** este asistente únicamente descargará 10 facturas.
